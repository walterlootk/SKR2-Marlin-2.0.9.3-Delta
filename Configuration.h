...
// Choose the name from boards.h that matches your setup WLOO
#ifndef MOTHERBOARD
 ...
 * :[-2, -1, 0, 1, 2, 3, 4, 5, 6, 7]
 * WLOO enabled two lines and for USB connection
 */
...
#define CUSTOM_MACHINE_NAME "ANYCUBIC Kossel SKR2"
...
#define DELTA
  ...
  // After homing move down to a height where XY movement is unconstrained WLOO
  ...
  // Distance between bed and nozzle Z home position WLOO (293.33 Manual Check to give 310.13 at LCD)
  #define DELTA_HEIGHT 293.33             // (mm) Get this value from G33 auto calibrate
 ...
 * WLOO - disabled this and enable probe at PE4
 */
#if ANYCUBIC_PROBE_VERSION > 0
 ...
 */
  ...
  #define NOZZLE_TO_PROBE_OFFSET { 0, 0, -16.80 }
...
//#define DEBUG_LEVELING_FEATURE
  ...
  //#define PROBE_Y_FIRST
    ...
    //#define EXTRAPOLATE_BEYOND_GRID WLOO
...
#define HOMING_FEEDRATE_MM_M { (35*60), (35*60), (35*60) }
